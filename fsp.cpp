...
void Stud::Modify()
{
	...
	if (found == 1)
	{
		...
		strcat(Buff, s1.name);
		strcat(Buff, "|");
		strcat(Buff, s1.address);
		strcat(Buff, "|");
		strcat(Buff, s1.semester);
		strcat(Buff, "|");
		strcat(Buff, s1.branch);
		strcat(Buff, "|");
		Next = strlen(Buff);
